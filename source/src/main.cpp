...
const uint8_t keyMapL0[totalRows][totalCols] = {
    {HID_KEY_ESCAPE, KEY_F1, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10, KEY_F11, KEY_F12, HID_KEY_SYSREQ_ATTENTION, KEY_INSERT, KEY_DELETE},
    {HID_KEY_BACKSLASH, HID_KEY_1, HID_KEY_2, HID_KEY_3, HID_KEY_4, HID_KEY_5, HID_KEY_6, HID_KEY_7, HID_KEY_8, HID_KEY_9, HID_KEY_0, HID_KEY_APOSTROPHE, 0, HID_KEY_BACKSPACE, 0, KEY_HOME},
    ...
    {HID_KEY_CAPS_LOCK, HID_KEY_A, HID_KEY_S, HID_KEY_D, HID_KEY_F, HID_KEY_G, HID_KEY_H, HID_KEY_J, HID_KEY_K, HID_KEY_L, 0, 0, HID_KEY_GRAVE, HID_KEY_ENTER, 0, HID_KEY_PAGE_UP},
    {HID_KEY_SHIFT_LEFT, 0, HID_KEY_Z, HID_KEY_X, HID_KEY_C, HID_KEY_V, HID_KEY_B, HID_KEY_N, HID_KEY_M, HID_KEY_COMMA, HID_KEY_PERIOD, HID_KEY_MINUS, KEY_RIGHT_SHIFT, 0, HID_KEY_ARROW_UP, HID_KEY_PAGE_DOWN},
    {HID_KEY_CONTROL_LEFT, HID_KEY_GUI_LEFT, 0, HID_KEY_ALT_LEFT, 0, 0, HID_KEY_SPACE, 0, 0, 0, HID_KEY_ALT_RIGHT, 0, HID_KEY_CONTROL_RIGHT, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_DOWN, HID_KEY_ARROW_RIGHT}};
